...
<template>
  <div
    class="overflow-hidden shadow-lg border-t-4 bg-white mb-4 rounded-l-lg rounded-t border-header w-full md:w-1/4"
  >
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center">
            <input
              ...
              type="checkbox"
              v-model="settingsStore.showUnfinishedRunners"
